        ...
        <>
            ...
            <form onSubmit={handleSubmit} className='container-sm md:container-xl flex flex-col gap-y-8 items-center mt-8' id='project-form'>
                ...
                {!loading ? (
                    ...
                    <button type="submit" class="bg-indigo-400 text-white py-2 px-4 rounded-md flex justify-center items-center cursor-not-allowed" disabled>
                        <svg aria-hidden="true" class="w-5 h-5 mr-2 text-gray-100 animate-spin fill-indigo-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
